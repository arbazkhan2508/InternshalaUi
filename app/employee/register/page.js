...
const index = () => {
  ...
  const formHandler = async (e) => {
    e.preventDefault();
    dispatch(asyncaddemployee(formData));
    setformData(initialFormData); // Reset form fields
    router.push("/employee/confirmp");
  };
    ...
    <>
      <div className={style.register_page}>
        <Link style={{ color: "#111" }} href="/">
          <RxCross2 className={style.crosss} />
        </Link>
          ...
          <div className={style.right_r}>
            ...
            >
              ...
              <button
                ...
                onClick={formHandler}
                type="submit"
                className="btn btn-primary text-center flex items-center justify-center w-48 mt-3 bg-yellow-500 "
              >
                Sign Up
              </button>
            </form>

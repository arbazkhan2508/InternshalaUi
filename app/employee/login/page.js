...
import { asyncloginemployee } from "@/store/Actions/employeeAction"
...
const index = () => {
  ...
  const router = useRouter();
    ...
    const formHandler = async (e)=>{
        e.preventDefault();
        dispatch(asyncloginemployee(formData))
  ...
  return (
    ...
    <>
       <div className={style.register_page}>
            <Link style={{color:"#111"}} href="/employee/home"><RxCross2 className={style.crosss} /></Link>
           <div className={style.register}>
            
               <div className={style.left_l}>
                    <h3>INFORMATION</h3>
                    <p> Your journey to knowledge begins here. Log in to access a wide range of courses and resources.</p>
               ...
               <div className={style.right_r}>
                   ...
                   <div className={style.options}>
                          ...
                          <div className={style.se}>
                              <h6 onClick={rempl} >Student</h6>
                              <h6 ref={pt} className={style.h6} >Employee</h6>
                          </div>
                     </div>
                     <form className="flex flex-col items-center mt-2" onSubmit={formHandler}>
                        ...
                        <div className="mb-3 flex flex-col gap-2">
                        <label style={{paddingLeft:"1vmax",fontWeight:"600",fontFamily:"roobert",letterSpacing:"1px"}} htmlFor="exampleInputPassword1" className="form-label">Password</label>
                        ...
                        <button style={button} onClick={formHandler} type="submit" className="btn btn-primary text-center flex items-center justify-center w-48 mt-3 bg-yellow-500 ">Login</button>
                     </form>
                     <div className={style.fp}>
                      <Link style={{textDecoration:"none",color:"#111"}} href="/student/forgot">
                     ...
                     <div className={style.dvg}>
                            <div onClick={rempl} className={style.ggl}>
